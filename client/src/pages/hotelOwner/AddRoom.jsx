...
const AddRoom = () => {
  ...
  return (
    <form>
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the detailes carefully and accurate room detailes, pricing, and amenities, to enhance the user booking experience.' />

      {/* Upload Areea For Images */}
